...
data class AirQuality(
    ...
    val o3: Double = 0.0,
    val so2: Double = 0.0,
    @param:Json(name = "pm2_5")
    val pm2_5: Double = 0.0,
    @param:Json(name = "pm10")
    val pm10: Double = 0.0,
    @param:Json(name = "us-epa-index")
    val usEpaIndex: Int = 0,
    @param:Json(name = "gb-defra-index")
